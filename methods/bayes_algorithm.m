function [ prob_dist, first_spike, last_spike ] = bayes_algorithm( time, spikes, model_params, time_window, iter_vars, velocity_K)
%
%function bayes_algorithm( time, spikes, model_params, time_window, iter_vars, velocity_K)
%
% WARNING : Not designed to be called independently. Called by parent reconstruction.m
%
% INPUT
% time          - Time of the timestep at which to decode. (in seconds)
...
%                 reconstruction.
% iter_vars     - Contains information about the previous timestep and reconstruction.
% velocity_K    - A constant that denotes how much of the velocity information is used
%                 in the two step correction step. 
%
% OUTPUT
% prob_dist     - A matrix of size MxN, containing the probability distribution of
%                 expected position. MxN is the grid size as specified during training.
%
